...
export default function FilteredCategoriesSlider() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        const filtered = allCategories.filter((cat) => cat.id >= 201 && cat.id <= 206);
          ...
          <div className="container-fluid">
            <div className="row cate-heading-parent">
              <div className="col-md-6 cate-heading">
                <h2 className="browse-heading">Service Categories</h2>
              </div>
            </div>
