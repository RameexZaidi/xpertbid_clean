...
useEffect(() => {
  ...
  //   setIsSearching(true);
  //   try {
  //     const response = await axios.get(`http://127.0.0.1:8000/api/search-auctions`, {
  //       params: { query },
  //     });
...
<div className="d-none d-xl-block">
  ...
  <Link
    href="/Real_Estate"
    className={`nav-link ${router.pathname === '/Real_Estate' ? 'active' : ''}`}
  >
    RealEstate
  </Link>
</li>
  ...
  <div className="dropdown">
    <button
      className="sellnow  dropdown-toggle flat-button"
      type="button"
      id="signupDropdown"
    ...
    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="signupDropdown">
      <li>
        {/* <button className="dropdown-item" onClick={() => handleOpenModal("Pricing")}>
          Sign Up as a Bidder
        </button> */}
      ...
      <li>
      <Link href="/Seller_Account" className="dropdown-item">
        Sign Up as a Seller
      </Link>
    </li>
                  ...
                  <li className="nav-item ">
                    ...
                    <li className="nav-item">
                      <Link
                        href="/categories"
                                            className={`nav-link ${
                                              router.pathname === '/Team' ? 'text-primary' : ''
                                            }`}
                        role="button"
                      >
                        Team
