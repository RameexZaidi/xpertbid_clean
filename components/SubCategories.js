    ...
    const fetchData = async () => {
      try {
        ...
        const subcategoryResponse = await axios.get(
          `http://127.0.0.1:8000/api/get-subcategories/${id}`
        );
        ...
        //   `http://127.0.0.1:8000/api/get-category-product/${id}`
        // );
                ...
                {subcategories.map((subcategory) => (
                  ...
                  <div className="col-lg-3 col-md-6 cate-card-main" key={subcategory.id}>
                      <div className="cate-card">
                        <Link href={`/child-categories/${subcategory.name}`} className="product-box">
